...
$Idjrm=$_GET['id'];
$ps=$pdo->prepare("SELECT * FROM jiram WHERE idjirm=?");
$params=array($Idjrm);
$ps->execute($params);
$reqbox=$ps->fetch();
?>
		...
		<div class="spacer panel-info panel-body body" id="body">
            ...
            <div class="container spacer col-sm-1 col-md-12 col-xs-4 col-md-offset-8">
                <div class="panel panel-info">
                    <div class="panel-heading navbar-dark"><h3>Modifier FACTURE JIRO</h3></div>
                        <div class="panel-body panel-body col-md-4">
                            <form method="post" action="Save_boxmod.php" enctype="multipart/form-data" id="editbox">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="num_box" value="<?php echo($reqbox['N_box'])?>" class="form-control text-center"id="numero_box" >
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Logement :</label>
                                    <input type="text" name="loge" class="form-control text-center" value="<?php echo($reqbox['val_prs'])?>" id="loge">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Sécurité :</label>
                                    <input type="text" name="sec" class="form-control text-center" value="<?php echo($reqbox['conso'])?>" id="securt">
                                </div>
                                <!--div class="form-group">
