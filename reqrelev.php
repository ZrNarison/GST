        ...
        <div class="panel-heading">
            <div class="panel-body">
              <form class="body-panel-body">
                <a href="relevelog.php" id="Logement2"  class="form-inline my-2 my-sm-0" type="submit"><< Logement</a>
                <label class="control-label" id="filr">FILTRAGE DE RECETTE PAR DATE :</label>
                <select id="c_mod" name="c_mod" class="form-group control-label text-center" onchange="charge_info()" >
                    <option  value=""  disabled selected>--Mois de--</option>
                ...
                <a href="releveelsec.php" id="electricite"  class="form-inline my-2 my-sm-0" type="submit">Eléctricité et Sécurité >></a>
                <table class="table rounded border border-primary" id="info">
                    ...
                    <tbody class="body-table" id="rqt">
                        ...
                        <!--?php while ($row=$info->fetch()){;?->
                            ...
                            <td><!-?php $dat=date("d-m-Y",strtotime($row['date_nais']));echo($dat); ?></td>
