          ...
          <div class="panel-heading">
            <div class="panel-body">
              <form class="body-panel-body">
                <a href="Admreleve.php" id="Logement2"  class="form-inline my-2 my-sm-0" type="submit"><< Recette mensuel</a>
                <label class="control-label" id="filr">FILTRAGE DE RECETTE LOGEMENT DU :</label>
                ...
                <a href="Admreleveelsec.php" id="electricite"  class="form-inline my-2 my-sm-0" type="submit">Eléctricité et Sécurité >></a>
