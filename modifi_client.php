...
$code=$_GET['code'];
$ps=$pdo->prepare("SELECT * FROM client WHERE idclient=?");
$params=array($code);
$ps->execute($params);
$client=$ps->fetch();?>
<div class="col-md-12 col-xs-12 spacer">
	<div class="panel panel-info">
		<div class="panel-heading"><h3>Editer Client</h3></div>
			<div class="panel-body">
			<a href="listClient.php" id="electricite"  class="form-inline my-2 my-sm-0" type="submit">Liste des Client</a>
				<form method="post" id="formclient" action="Update_client.php" enctype="multipart/form-data">
					<div class="form-group">
						<div class="form-inline mr-sm-2">
							<label class="control-label">Nom :</label>
							<input type="text" name="nom_ver" value="<?php echo($client['Nom'])?>" class="form-control text-center" placeholder="Nom du personne" style="width: 60%;margin-left: 96px">
						</div>
					</div>
					<div class="form-group">
						<div class="form-inline mr-sm-2">
							<label class="control-label">Prénom :</label>
							<input type="text" name="pre_ver" value="<?php echo($client['Prenom'])?>" class="form-control text-center" placeholder="Prénom du personne" style="width: 60%;margin-left: 76px">
						</div>
					</div>
					<div class="form-group ">
						<div class="form-inline mr-sm-2">
							<label class="control-label">Né (e) le :</label>
							<input type="text" name="lieu_nais" value="<?php echo($client['date_naissance'])?>" class="form-control text-center" id="date_nais">
							<label class="control-label"> à :</label>
							<input type="text" name="lieu_nais" value="<?php echo($client['lieu_naissance'])?>" class="form-control text-center" placeholder="Lieu de naissance">
						</div>
					</div>
					<div class="form-group">
						<div class="form-inline mr-sm-2"-->
							<label>CIN</label>
							<input type="text" name="cin" value="<?php echo($client['n_cin'])?>" id="cin" class="form-control text-center" placeholder="N° CIN">
							<label> du :</label>
